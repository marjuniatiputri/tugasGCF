...
document.addEventListener('DOMContentLoaded', () => {
    const map = new ol.Map({
        ...
        view: new ol.View({
            center: ol.proj.fromLonLat([115.22366121279074,-8.652816155515243]),   
            zoom: 15
        })
    });
      ...
      const waypointSource = new ol.source.Vector({
        url: 'https://raw.githubusercontent.com/marjuniatiputri/open-layer/main/waypoint.json',
        format: new ol.format.GeoJSON()
    });

    const lineStringSource = new ol.source.Vector({
        url: 'https://raw.githubusercontent.com/marjuniatiputri/open-layer/main/polygon.json', 
        format: new ol.format.GeoJSON()
    });

    const polylineSource = new ol.source.Vector({
        url: 'https://raw.githubusercontent.com/marjuniatiputri/open-layer/main/polyline.json',
        format: new ol.format.GeoJSON()
    });
